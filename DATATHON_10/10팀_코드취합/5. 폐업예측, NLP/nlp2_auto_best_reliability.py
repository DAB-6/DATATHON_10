...
req_cols_m3 = ["state", "category", "logit_w_reliability", "reliability_flag"]
...
best_idx = ok_m3["logit_w_reliability"].idxmax()
...
print("\n🏆 선택된 조합 (최고 logit_w_reliability & reliability_flag='ok'):")
